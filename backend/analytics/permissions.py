...
class CanViewAnalytics(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return (request.user and request.user.is_authenticated and
                (request.user.is_staff or request.user.is_lecturer or getattr(request.user, 'role', '') == 'professor'))
...
class CanViewOwnAnalytics(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.user.is_staff or request.user.is_lecturer or getattr(request.user, 'role', '') == 'professor':
            return True
