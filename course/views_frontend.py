...
def program_add(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("frontend:course:programs")
...
def course_add(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("frontend:course:program_detail", pk=program.pk)
        messages.error(request, "Correct the error(s) below.")
    else:
...
def course_edit(request, slug):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("frontend:course:program_detail", pk=course.program.pk)
        messages.error(request, "Correct the error(s) below.")
    else:
...
def course_delete(request, slug):
    ...
    return redirect("frontend:course:program_detail", pk=program_id)
...
class CourseAllocationFormView(CreateView):
    ...
    def form_valid(self, form):
        ...
        return redirect("frontend:course:course_allocation_view")
...
def course_registration(request):
    if request.method == "POST":
        ...
        return redirect("frontend:course:course_registration")
    else:
